...
# Odds ratios for j = 3 vs. j = 1 
OR3_1<-exp(c.value*beta.hat3)
OR1_3<-1/exp(c.value*beta.hat3)

# Odds ratios for j = 4 vs. j = 1
OR4_1<-exp(c.value*beta.hat4)
OR1_4<-1/exp(c.value*beta.hat4)

# Odds ratios for j = 3 vs j = 2
OR3_2<-exp(c.value*(beta.hat3 - beta.hat2))
OR2_3<-1/OR3_2
              
# Odds ratios for j = 4 vs j = 3
OR4_3<-exp(c.value*(beta.hat4-beta.hat3))
OR3_4<-1/OR4_3

# Odds ratios for j = 4 vs j = 2
OR4_2<-exp(c.value*(beta.hat4-beta.hat2))
OR2_4<-1/OR4_2
```
...
"Shelf 4 vs Shelf 2"
round(data.frame(low = ci.OR4[,1]/ci.OR2[,1], up = ci.OR4[,2]/ci.OR2[,2]), 2) #shelf 4 relative to 2
